...
const extendedTourDetails = {
  1: {
    fullDescription: "Embark on a breathtaking aerial journey above Hong Kong's iconic Victoria Harbour, where towering skyscrapers meet the shimmering waters in perfect harmony. This immersive AR-enhanced flight showcases the city's architectural marvels, from the gleaming IFC Tower to the historic Star Ferry Terminal. Experience the pulse of one of the world's busiest harbors while our advanced AR overlay reveals hidden stories, architectural secrets, and real-time harbor activity.",
    itinerary: [
      { time: "14:00", activity: "Departure from Central Helipad", description: "Safety briefing and AR equipment setup" },
      { time: "14:05", activity: "IFC Tower Flyby", description: "Close-up views of Hong Kong's second tallest building" },
      { time: "14:15", activity: "Victoria Harbour Circuit", description: "360-degree harbor views with AR historical overlay" },
      { time: "14:25", activity: "Bank of China Tower Approach", description: "Architectural marvel designed by I.M. Pei" },
      { time: "14:35", activity: "Star Ferry Terminal Landing Zone", description: "Views of historic ferry operations" },
      { time: "14:45", activity: "Arrival at Tsim Sha Tsui Terminal", description: "Tour completion and equipment return" }
    ],
    inclusions: [
  ...
  2: {
    fullDescription: "Discover the spiritual heart of Hong Kong through this unique aerial journey that combines ancient traditions with modern cityscapes. Soar above sacred temples, traditional markets, and cultural heritage sites while our AR technology reveals the fascinating stories, legends, and cultural significance of each landmark. This tour offers a rare perspective on Hong Kong's rich multicultural heritage and the harmonious blend of East and West.",
    itinerary: [
      { time: "16:30", activity: "Departure from Wong Tai Sin Helipad", description: "Traditional blessing ceremony and equipment setup" },
      { time: "16:35", activity: "Wong Tai Sin Temple Overview", description: "AR-enhanced views of the colorful Taoist temple" },
      { time: "16:45", activity: "Chi Lin Nunnery Approach", description: "Tang Dynasty architecture and lotus pond gardens" },
      { time: "16:55", activity: "Temple Street Market Flyover", description: "Bustling night market preparation views" },
      { time: "17:05", activity: "Man Mo Temple District", description: "Historic Hollywood Road temple complex" },
      { time: "17:30", activity: "Landing at Man Mo Temple Area", description: "Ground-level temple visit opportunity" }
    ],
    inclusions: [
    ...
    coordinates: {
      ...
      waypoints: [
        ...
        [22.3400, 114.1925], // Wong Tai Sin Temple
...
export default function TourDetailPage({ params }) {
  ...
  const tour = basicTourData[tourId];
  const extendedDetails = extendedTourDetails[tourId];
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-black text-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400 mb-6">The requested tour could not be found.</p>
          <Link
  ...
  const getAvailabilityStatus = (availableSeats, totalSeats) => {
    ...
    if (percentage === 0) return { status: 'Fully Booked', color: 'text-red-400 bg-red-500/10 border-red-500/20' };
            ...
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-4 text-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-gray-300">{formatDate(tour.date)}</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-blue-400 rounded-full"></div>
                    <span className="text-gray-300">{formatTime(tour.time)}</span>
                  </div>
                  <div className="flex items-center gap-2">
              ...
              <div className="bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-lg rounded-2xl p-6 border border-gray-700/50 min-w-80">
                <div className="text-center mb-4">
                  <div className="text-4xl font-bold text-emerald-400 mb-2">${tour.price}</div>
                  <div className="text-gray-400">per person</div>
                </div>

                <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium border ${availability.color} mb-4 w-full justify-center`}>
          ...
          <div className="bg-gradient-to-br from-gray-800/40 to-gray-900/40 backdrop-blur-lg rounded-2xl p-8 border border-gray-700/50 mb-8">
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-gray-800/30 rounded-lg p-4 border border-gray-700/30">
                ...
                <div className="text-white font-medium">{tour.startLocation}</div>
                <div className="text-gray-400 text-sm">{formatTime(tour.time)}</div>
              </div>
              <div className="bg-gray-800/30 rounded-lg p-4 border border-gray-700/30">
                <div className="flex items-center gap-3 mb-2">
                ...
                <div className="text-gray-400 text-sm">
                  {(() => {
                    ...
                    const durationMinutes = parseInt(tour.duration.match(/\d+/)[0]);
