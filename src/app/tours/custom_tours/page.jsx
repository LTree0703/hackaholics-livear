...
function CustomRouteMap({ departure, destination, waypoints }) {
  ...
  const generateRouteCoordinates = () => {
    ...
    return {
      ...
      waypoints: routePoints.map(
        (point) => point.coordinates || point.coordinates
      ),
    };
  };
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-center gap-8 text-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-300">
              ~{30 + waypoints.length * 10} min flight
            </span>
          </div>
          <div className="flex items-center gap-2">
...
const helipadLocations = [
  {
    id: 1,
    name: "Central Helipad",
    coordinates: [22.2855, 114.1577],
    district: "Central",
    type: "Premium",
  },
  {
    id: 2,
    name: "Tsim Sha Tsui Terminal",
    coordinates: [22.2938, 114.1722],
    district: "Tsim Sha Tsui",
    type: "Premium",
  },
  {
    id: 3,
    name: "Ocean Terminal Helipad",
    coordinates: [22.2945, 114.1685],
    district: "Kowloon",
    type: "Standard",
  },
  {
    id: 4,
    name: "Wong Tai Sin Helipad",
    coordinates: [22.3411, 114.1944],
  ...
  },
  {
    id: 5,
    name: "Peak Helipad",
    coordinates: [22.2703, 114.1394],
    district: "The Peak",
    type: "Scenic",
  },
  {
    id: 6,
    name: "Mid-Levels Terminal",
    coordinates: [22.2769, 114.1435],
    district: "Mid-Levels",
    type: "Luxury",
  },
  {
    id: 7,
    name: "Sha Tin Helipad",
    coordinates: [22.3858, 114.1986],
  ...
  },
  {
    id: 8,
    name: "Tai Po Landing",
    coordinates: [22.4412, 114.1671],
    district: "New Territories",
    type: "Nature",
  },
  {
    id: 9,
    name: "Convention Centre Landing",
    coordinates: [22.2832, 114.1734],
    district: "Wan Chai",
    type: "Business",
  },
  {
    id: 10,
    name: "Mong Kok Night Terminal",
...
export default function CustomToursPage() {
  ...
  useEffect(() => {
    if (selectedDeparture && selectedDestination) {
      ...
      const experience = experienceTypes.find(
  ...
  const canProceedToNext = () => {
    switch (currentStep) {
      case 1:
        return selectedDeparture && selectedDestination;
      case 2:
        return selectedExperience;
      case 3:
        return selectedDate && selectedTime && passengers > 0;
      default:
        return false;
    }
  };
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Create your perfect aerial adventure. Choose your route, add
              landmarks, and customize your experience.
            </p>
          </div>
              ...
              {currentStep === 1 && (
                <div className="bg-gradient-to-br from-gray-800/40 to-gray-900/40 backdrop-blur-lg rounded-2xl p-8 border border-gray-700/50">
                  ...
                  <div className="mb-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      {helipadLocations
                        .filter((loc) => loc.id !== selectedDeparture?.id)
                        .slice(0, 6)
                        .map((location) => (
                          <button
                            key={location.id}
                          ...
                          >
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <div className="text-xs text-gray-400">
                                  {waypoint.category} • +{waypoint.duration}
                                </div>
                              </div>
                            </div>
                            <button
                      ...
                      >
                        <div className="flex items-start justify-between mb-3">
                          ...
                          <div className="text-right">
                            <div className="text-lg font-bold">
                              +
                              {Math.round(
                                (experience.priceMultiplier - 1) * 100
                              )}
                              %
                            </div>
                            <div className="text-xs text-gray-400">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {experience.features.map((feature, index) => (
                            <span
                              key={index}
                              className="bg-gray-700/50 text-xs px-2 py-1 rounded-full"
                            >
                              {feature}
                            </span>
                          ))}
              ...
              <div className="sticky top-24 bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-lg rounded-2xl p-6 border border-gray-700/50">
                    ...
                    {selectedDeparture && (
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-gray-400">
                            Departure • {selectedDeparture.district}
                          </div>
                        </div>
                      </div>
                    )}
                    ...
                    {selectedDestination && (
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-gray-400">
                            Arrival • {selectedDestination.district}
                          </div>
                        </div>
                      </div>
                    )}
                ...
                {selectedDate && selectedTime && (
                  <div className="mb-6 p-4 bg-gray-800/30 rounded-lg">
                    ...
                    <div className="text-sm text-gray-300">
                      {selectedTime} • {estimatedDuration} minutes
                    </div>
                  </div>
                )}
                ...
                {selectedExperience && (
                  <div className="mb-6 p-4 bg-gray-800/30 rounded-lg">
                    ...
                    <div className="font-medium text-white">
                      {
                        experienceTypes.find((e) => e.id === selectedExperience)
                          ?.name
                      }
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-xl p-4 mb-4 mx-auto max-w-xs">
                <div className="text-center mb-3">
                  ...
                  <p className="text-xs text-gray-600">
                    Scan this QR code at departure
                  </p>
                </div>
