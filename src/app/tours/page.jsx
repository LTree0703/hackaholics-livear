          ...
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Choose your perfect aerial adventure with our premium eVTOL
                experiences. From scheduled group tours to custom private
                flights, discover Hong Kong like never before.
              </p>
            </div>
                ...
                <div className="bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-lg rounded-2xl p-8 border border-gray-700/50 hover:border-emerald-500/30 transition-all duration-500 hover:shadow-2xl hover:shadow-emerald-500/10 transform hover:scale-105">
                  <div className="text-center">
                    ...
                    <p className="text-gray-300 mb-6 leading-relaxed">
                      Join our expertly curated flights with fixed routes,
                      scheduled departures, and professional guides. Perfect for
                      first-time flyers and group experiences.
                    </p>
                    <div className="space-y-3 text-left">
                      <div className="flex items-center gap-3">
                        <div className="w-2 h-2 bg-emerald-400 rounded-full"></div>
                        <span className="text-sm text-gray-300">
                          Professional AR-enhanced tours
                        </span>
                      </div>
                      <div className="flex items-center gap-3">
                        <div className="w-2 h-2 bg-emerald-400 rounded-full"></div>
              ...
              <Link href="/tours/custom_tours" className="group">
                <div className="bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-lg rounded-2xl p-8 border border-gray-700/50 hover:border-blue-500/30 transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/10 transform hover:scale-105">
                  <div className="text-center">
                    ...
                    <p className="text-gray-300 mb-6 leading-relaxed">
                      Design your own unique aerial experience with personalized
                      routes, flexible timing, and exclusive access to premium
                      locations.
                    </p>
                    <div className="space-y-3 text-left">
                      <div className="flex items-center gap-3">
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-white mb-4">
                Why Choose LiveAR Tours?
              </h2>
              <p className="text-gray-300 max-w-2xl mx-auto">
                Experience the future of aerial tourism with our cutting-edge
                eVTOL aircraft and immersive AR technology.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-gradient-to-br from-gray-800/40 to-gray-900/40 backdrop-blur-lg rounded-xl p-6 border border-gray-700/50 text-center">
                ...
                <p className="text-gray-300 text-sm">
                  See Hong Kong like never before with real-time AR overlays
                  showing historical information, architectural details, and
              ...
              <div className="bg-gradient-to-br from-gray-800/40 to-gray-900/40 backdrop-blur-lg rounded-xl p-6 border border-gray-700/50 text-center">
                ...
                <p className="text-gray-300 text-sm">
                  Fly guilt-free with our electric vertical take-off aircraft.
                  Sustainable tourism that protects Hong Kong's environment for
                  future generations.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-gray-800/40 to-gray-900/40 backdrop-blur-lg rounded-xl p-6 border border-gray-700/50 text-center">
                ...
                <p className="text-gray-300 text-sm">
                  Professional pilots, state-of-the-art safety systems, and
                  comprehensive insurance ensure your aerial adventure is both
          ...
          <div className="container mx-auto max-w-4xl">
            <div className="bg-gradient-to-r from-gray-800/60 to-gray-900/60 backdrop-blur-lg rounded-2xl p-8 border border-gray-700/50 text-center">
              ...
              <p className="text-gray-300 mb-8 text-lg">
                ...
                Book your LiveAR tour today and see the city from a whole new
                perspective.
              </p>
