  ...
  useEffect(() => {
    const login = async () => {
      if (isLoaded) {
        ...
        await getOrCreateUser(user.emailAddresses[0].emailAddress, user.id);
      }
    };
    login();
  }, [isLoaded, user]);
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-4 max-w-3xl mx-auto leading-relaxed">
              ...
              that transform your flight into an
              <span className="text-emerald-400 font-semibold">
                {" "}
                immersive journey
              </span>
            ...
            <p className="text-lg text-gray-400 mb-8 max-w-2xl mx-auto">
              Our eVTOL aircraft fly close to the ground, giving you intimate
              city views while AR technology highlights landmarks, reveals
              hidden stories, and overlays digital sceneries on your window
              view.
            </p>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Our revolutionary AR windows don't just show you the city – they
              bring it to life
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div className="bg-gray-800/30 backdrop-blur-sm rounded-xl p-6 border-l-4 border-emerald-500">
                <h3 className="text-xl font-semibold text-emerald-400 mb-3 flex items-center gap-3">
                  <span className="w-8 h-8 bg-emerald-500 rounded-full flex items-center justify-center text-sm">
                    🏛️
                  </span>
                  Landmark Recognition
                </h3>
                <p className="text-gray-300">
                  Our AI instantly identifies and highlights historical
                  buildings, monuments, and points of interest as you fly past
                  them.
                </p>
              </div>
              ...
              <div className="bg-gray-800/30 backdrop-blur-sm rounded-xl p-6 border-l-4 border-emerald-500">
                ...
                <p className="text-gray-300">
                  See your real-time route overlaid on the window, with upcoming
                  attractions and optimal photo spots highlighted.
                </p>
              </div>
              ...
              <div className="bg-gray-800/30 backdrop-blur-sm rounded-xl p-6 border-l-4 border-emerald-500">
                ...
                <p className="text-gray-300">
                  Watch historical scenes unfold, see how areas looked in the
                  past, or enjoy artistic interpretations of the landscape.
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">
              Choose Your{" "}
              <span className="text-emerald-400">AR Flight Experience</span>
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Step into the future of urban tourism with our AR-enhanced eVTOL
              flights. Select the experience that fits your adventure style.
            </p>
          </div>
          ...
          <div className="mb-16">
            <div className="text-center mb-8">
              <h3 className="text-3xl font-bold text-white mb-4">
                <span className="text-emerald-400">Helipad Network</span> Across
                Hong Kong
              </h3>
              <p className="text-lg text-gray-300 max-w-2xl mx-auto">
                Explore our extensive network of 20 helipads strategically
                located across Hong Kong. Click on any red marker to view
                helipad details and available tour options.
              </p>
            </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
            ...
            <Link href="/tours/scheduled_tours" className="group">
              <div className="h-full bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-lg rounded-2xl p-8 border border-gray-700/50 hover:border-emerald-500/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-emerald-500/10">
                ...
                <h3 className="text-2xl font-bold mb-4 text-emerald-400 text-center group-hover:text-emerald-300 transition-colors">
                  Scheduled Tours
                </h3>
                <p className="text-gray-300 text-center mb-6 leading-relaxed">
                  Join our expertly curated flights. Perfect for first-time
                  visitors with pre-planned routes and AR storytelling.
                </p>
            ...
            <Link href="/tours/custom_tours" className="group">
              <div className="h-full bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-lg rounded-2xl p-8 border border-gray-700/50 hover:border-blue-500/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/10">
                ...
                <h3 className="text-2xl font-bold mb-4 text-blue-400 text-center group-hover:text-blue-300 transition-colors">
                  Custom Tours
                </h3>
                <p className="text-gray-300 text-center mb-6 leading-relaxed">
                  Design your personalized flight route with AR experiences
                  tailored to your interests. Private aircraft with flexible
                  timing.
                </p>
            ...
            <Link href="/demo" className="group">
              <div className="h-full bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-lg rounded-2xl p-8 border border-gray-700/50 hover:border-purple-500/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/10">
                ...
                <h3 className="text-2xl font-bold mb-4 text-purple-400 text-center group-hover:text-purple-300 transition-colors">
                  AR Technology Demo
                </h3>
                <p className="text-gray-300 text-center mb-6 leading-relaxed">
                  Experience our revolutionary AR windows before you fly.
                  Interactive ground-based demonstration of all AR features.
                </p>
          ...
          <div className="bg-gradient-to-r from-gray-800/60 to-gray-900/60 backdrop-blur-lg rounded-2xl p-8 border border-gray-700/50 text-center">
            ...
            <div className="grid md:grid-cols-4 gap-6 text-sm">
              <div className="flex flex-col items-center">
                ...
                <p className="text-gray-300">
                  Certified pilots with extensive eVTOL experience
                </p>
              </div>
              <div className="flex flex-col items-center">
                ...
                <p className="text-gray-300">
                  Revolutionary AR windows with immersive overlays
                </p>
              </div>
              <div className="flex flex-col items-center">
                <div className="text-3xl mb-3">🌱</div>
                ...
                <p className="text-gray-300">
                  Zero emissions electric aircraft technology
                </p>
              </div>
              <div className="flex flex-col items-center">
                <div className="text-3xl mb-3">🌆</div>
                ...
                <p className="text-gray-300">
                  Intimate city views at optimal flying heights
                </p>
              </div>
            </div>
          </div>
